...
namespace Translator.Crypto
{
    public class BlowFishPckVer
    {
        ...
        public BlowFishPckVer(string hexKey)
        {
        ...
        public BlowFishPckVer(byte[] cipherKey)
        {
            randomSource = new RNGCryptoServiceProvider();
            SetupKey(cipherKey);
        }
     ...
     /*   private void encipher()
      ...
      /*  private void decipher()
        ...
        private void encipher(bool init)
        {
            ...
            for (uint i = 0; i < 16; i++)
            {
                xl_par = xl_par ^ bf_P[i];
                xr_par = F(xl_par) ^ xr_par;
            ...
            xl_par = xr_par;
            xr_par = temp;
            xr_par = xr_par ^ bf_P[16];
            xl_par = xl_par ^ bf_P[17];
            if (!init)
            {
                temp = xl_par;
                xl_par = xr_par;
